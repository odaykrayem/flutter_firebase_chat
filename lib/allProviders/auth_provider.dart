...
import 'package:flutter_firebase_chat/allConstants/firestore_constants.dart';
import 'package:flutter_firebase_chat/allModels/user_chat.dart';
  ...
  Future<bool> handleSignIn() async{
    ...
    if(googleUser != null){
      ...
      if(firebaseUser != null){
       ...
       //the user is already signedUp
       else{
         DocumentSnapshot documentSnapshot = document[0];
         UserChat userChat = UserChat.fromDocument(documentSnapshot);

         await prefs.setString(FirestoreConstants.id, userChat.id);
         await prefs.setString(FirestoreConstants.nickname, userChat.name ?? "");
